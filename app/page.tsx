        ...
        <div className="max-w-5xl mx-auto px-5 py-16 w-full">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-5 text-soft max-w-xl text-base sm:text-lg hero-in hero-in-3">
              Lacak progres Cybersecurity dan Matematika. Setiap video &amp;
              materi jadi ceklis interaktif yang tersimpan di perangkat Anda.
            </p>
          </div>

          <div className="grid sm:grid-cols-2 gap-5 max-w-2xl mx-auto mt-12 hero-in hero-in-4">
            <Link href="/cyber" className="track-card group">
              ...
              <div className="track-body">
                ...
                <div className="track-title">90-Day Study Plan</div>
                <div className="track-meta">
                  {cyber.done}/{cyber.total} selesai · {cyber.pct}%
                </div>
              </div>
              <ArrowRight
                size={20}
            ...
            <Link href="/math" className="track-card group">
              ...
              <div className="track-body">
                ...
                <div className="track-title">Professor Dave Explains</div>
                <div className="track-meta">
                  {math.done}/{math.total} video · {math.pct}%
                </div>
              </div>
              <ArrowRight
                size={20}
